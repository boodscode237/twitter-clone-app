    ...
    <div className='flex space-x-2 p-5'>
        ...
        <div className='flex flex-1 items-center pl-2'>
            <form className='flex flex-1 flex-col'>
                ...
                className='h-24 w-full text-xl outline-none placeholder:text-xl' type="text" placeholder="What's up dude?" />
                <div className='flex items-center'>
                    ...
                    <button
                    disabled={!input}
                    className='bg-twitter px-5 py-2 font-bold text-yellow-50 rounded-full disabled:opacity-40'>Tweet</button>
                </div>
            </form>
        </div>
    </div>
